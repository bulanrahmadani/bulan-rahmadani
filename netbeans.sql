...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 10, 2023 at 02:20 AM
...
(1, 'adiva', '123', 'adiva zafira', 'admin'),
(2, 'zidan', '123', 'zidan adzaky', 'petugas');
...
--
ALTER TABLE `spp`
  MODIFY `id_spp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;COMMIT;
